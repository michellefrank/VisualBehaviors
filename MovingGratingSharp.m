...
sizegrid = texsize*2+pixPerCycle;

% Make sure you have an even number of spots for the gratings
if mod(sizegrid,2) ~= 0
    sizegrid = sizegrid - 1;
end
...
stripeUnit = [1 1];
stripeUnit(:,:,2) = [1 0];
numStripes = round(sizegrid/stripeWidth);
% Multiply the stripes to get the right number
mask = repmat(stripeUnit, 1, numStripes);
